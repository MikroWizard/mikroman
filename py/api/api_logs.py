...
def dashboard_stats():
    ...
    try:
        req = requests.get(feedurl, timeout=(0.5,1)) 
    ...
    noconnectiondata={
                ...
                "summery": "Unable to connect mikrowizard.com to get latest News! <a  target=\"_blank\" href=\"http://mikrowizard.com/plan-your-project-with-your-software/\">Read More</a>",
